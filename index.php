<?php
	...
	// Baris komentar: ....
	function hitung_tagihan_awal( $jumlahPesanan, $hargaSatuan){
		$tagihanAwal = $jumlahPesanan * $hargaSatuan;
		return $tagihanAwal;
	}

	//	Instruksi Kerja Nomor 2.
	//	Variabel lokasi berisi data kota lokasi restoran dalam bentuk array.
	$lokasii = array("Tangerang","Bogor","Jakarta","Depok","Bekasi");
	...
	<?php
		...
		if(isset($_POST['Pesan'])) {
	        ...
	        if($dataPesanan['lokasi'] == "Tangerang"){
				...
				$ongkir = 10000;
			}elseif($dataPesanan['lokasi'] == "Jakarta"){
				$ongkir = 0;
			}elseif($dataPesanan['lokasi'] == "Depok"){
				$ongkir = 0;
			}elseif($dataPesanan['lokasi'] == "Bekasi"){
				$ongkir = 0;
			}else{
				$ongkir = 0;
			}
